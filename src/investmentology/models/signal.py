...
class SignalTag(StrEnum):
    ...
    MANAGEMENT_MISALIGNED = "MANAGEMENT_MISALIGNED"
    ROIC_IMPROVING = "ROIC_IMPROVING"
    ROIC_DECLINING = "ROIC_DECLINING"
    CAPITAL_ALLOCATION_EXCELLENT = "CAPITAL_ALLOCATION_EXCELLENT"
    CAPITAL_ALLOCATION_POOR = "CAPITAL_ALLOCATION_POOR"
    ...
    PRICED_FOR_PERFECTION = "PRICED_FOR_PERFECTION"
    PRICED_FOR_DISASTER = "PRICED_FOR_DISASTER"
    CONSENSUS_WRONG_BULL = "CONSENSUS_WRONG_BULL"
    CONSENSUS_WRONG_BEAR = "CONSENSUS_WRONG_BEAR"
    SENTIMENT_EUPHORIC = "SENTIMENT_EUPHORIC"
    SENTIMENT_FEARFUL = "SENTIMENT_FEARFUL"
    ...
    CATALYST_FAR = "CATALYST_FAR"
    CATALYST_MISSING = "CATALYST_MISSING"
    MOAT_WIDE = "MOAT_WIDE"
    MOAT_NARROW = "MOAT_NARROW"
    MOAT_NONE = "MOAT_NONE"
    REFLEXIVITY_DETECTED = "REFLEXIVITY_DETECTED"
    REGIME_TRANSITION_UP = "REGIME_TRANSITION_UP"
    REGIME_TRANSITION_DOWN = "REGIME_TRANSITION_DOWN"
    REGIME_CHOPPY = "REGIME_CHOPPY"
    CYCLE_EARLY = "CYCLE_EARLY"
    CYCLE_MID = "CYCLE_MID"
    CYCLE_LATE = "CYCLE_LATE"
    CYCLE_CONTRACTION = "CYCLE_CONTRACTION"
    RATES_STABLE = "RATES_STABLE"
    ...
    PATTERN_BULL_FLAG = "PATTERN_BULL_FLAG"
    PATTERN_BASE_FORMING = "PATTERN_BASE_FORMING"
    ...
    RISK_LITIGATION = "RISK_LITIGATION"
    RISK_KEY_PERSON = "RISK_KEY_PERSON"
    RISK_CUSTOMER_CONCENTRATION = "RISK_CUSTOMER_CONCENTRATION"
    PORTFOLIO_OVER_EXPOSED = "PORTFOLIO_OVER_EXPOSED"
    PORTFOLIO_UNDERWEIGHT_CASH = "PORTFOLIO_UNDERWEIGHT_CASH"
    ...
    SPINOFF_SELLING_PEAK = "SPINOFF_SELLING_PEAK"
    ...
    NO_ACTION = "NO_ACTION"
    MISSED = "MISSED"
    REASON_THESIS_BROKEN = "REASON_THESIS_BROKEN"
    REASON_STOP_LOSS = "REASON_STOP_LOSS"
    REASON_TARGET_REACHED = "REASON_TARGET_REACHED"
    REASON_OPPORTUNITY_COST = "REASON_OPPORTUNITY_COST"
    REASON_REGIME_SHIFT = "REASON_REGIME_SHIFT"
    REASON_REBALANCE = "REASON_REBALANCE"
    REASON_TAX_LOSS = "REASON_TAX_LOSS"
    REASON_POSITION_LIMIT = "REASON_POSITION_LIMIT"
    FORCED_SELLING_OVERRIDE = "FORCED_SELLING_OVERRIDE"
