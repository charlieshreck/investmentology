...
FUNDAMENTAL_TAGS: frozenset[SignalTag] = frozenset({
    ...
    SignalTag.PRICED_FOR_PERFECTION, SignalTag.PRICED_FOR_DISASTER,
    SignalTag.MOAT_WIDE, SignalTag.MOAT_NARROW, SignalTag.MOAT_NONE,
})
...
MACRO_TAGS: frozenset[SignalTag] = frozenset({
    ...
    SignalTag.CONSENSUS_WRONG_BULL, SignalTag.CONSENSUS_WRONG_BEAR,
    SignalTag.SENTIMENT_EUPHORIC, SignalTag.SENTIMENT_FEARFUL, SignalTag.SENTIMENT_NEUTRAL,
...
RISK_TAGS: frozenset[SignalTag] = frozenset({
    ...
    SignalTag.ASYMMETRIC_UPSIDE, SignalTag.ASYMMETRIC_DOWNSIDE,
    SignalTag.PERMANENT_LOSS_RISK,
    SignalTag.CATALYST_NEAR, SignalTag.CATALYST_FAR, SignalTag.CATALYST_MISSING,
})
...
TAG_ALIASES: dict[str, str] = {
    ...
    "TECHNICAL_DOWNSIDE_RISK": "BREAKDOWN_CONFIRMED",
    "VALUATION_CONCERN": "OVERVALUED",
    "VALUATION_STRETCHED": "OVERVALUED",
    "ANALYST_DIVERGENCE": "CONFLICT_FLAG",
    # Common new-agent hallucinations
    "CONCENTRATION_RISK": "CONCENTRATION",
    "MACRO_HEADWINDS": "GEOPOLITICAL_RISK",
    "CATALYST_PENDING": "MACRO_CATALYST",
    "RISK_REWARD_FAVORABLE": "UNDERVALUED",
    "RISK_REWARD_UNFAVORABLE": "OVERVALUED",
    # Howard Marks / second-level thinking hallucinations
    "FAIR_VALUE": "FAIRLY_VALUED",
    "MOAT_STRONG": "MOAT_WIDE",
    "MOAT_WEAK": "MOAT_NARROW",
    "MOAT_ABSENT": "MOAT_NONE",
    "CONSENSUS_BULLISH": "CONSENSUS_WRONG_BULL",
    "CONSENSUS_BEARISH": "CONSENSUS_WRONG_BEAR",
    "SENTIMENT_GREEDY": "SENTIMENT_EUPHORIC",
    "SENTIMENT_PANICKED": "SENTIMENT_FEARFUL",
    "CATALYST_IMMINENT": "CATALYST_NEAR",
    "CATALYST_ABSENT": "CATALYST_MISSING",
    "ASYMMETRIC_OPPORTUNITY": "ASYMMETRIC_UPSIDE",
    "PERMANENT_CAPITAL_LOSS": "PERMANENT_LOSS_RISK",
    "CAPITAL_LOSS_RISK": "PERMANENT_LOSS_RISK",
    "PENDULUM_EXTREME": "PRICED_FOR_PERFECTION",
}
